...
/** @type {string} */
const CACHE_VERSION = '1769018858|1219641988';
/** @type {string} */
const CACHE_PREFIX = 'shrek game-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'shrekgame.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["shrekgame.html","shrekgame.js","shrekgame.offline.html","shrekgame.icon.png","shrekgame.apple-touch-icon.png","shrekgame.audio.worklet.js","shrekgame.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["shrekgame.wasm","shrekgame.pck"];
